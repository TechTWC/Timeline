 ...
 * never call the same thing two different names. 'My Timeline Visualizer' stays untranslated as the
...
export const ko: Strings = {
  appName: 'My Timeline Visualizer',
  appShortName: '타임라인',
  ...
  errorFormatUnsupported: '이 브라우저에서는 {width}×{height} 영상을 만들 수 없습니다. 다른 형식을 선택하세요.',
